...
import { installShipPulseSkill } from "./skill-install.js";
...
/**
 * Polling agents use sessions_spawn to hand work to a worker session.
 * The agent must be allowed to spawn itself or spawn is forbidden.
 */
...
function upsertAgent(
  ...
  // Never overwrite the user's default (main) agent — it was configured outside shippulse.
